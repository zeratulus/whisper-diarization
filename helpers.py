...
def create_config_custom(output_dir):
...
def load_config(output_dir, config_file, msdd_model):
    config = OmegaConf.load(config_file)
    print("Successfully loaded OmegaConf.")
    ...
    config.diarizer.vad.parameters.pad_offset = -0.05
    config.diarizer.msdd_model.model_path = (
        msdd_model  # Telephonic speaker diarization model
    )
